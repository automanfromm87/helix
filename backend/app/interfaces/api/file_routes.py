...
async def download_file_with_signature(
    ...
    # Storage raises NotFoundError for both missing-file and wrong-user cases.
...
async def download_file(
    ...
    file_data, file_info = await file_service.download_file(
        file_id, current_user.id if current_user else None
    )
...
async def create_file_signed_url(
    ...
    # create_signed_url already raises NotFoundError on missing/forbidden file.
