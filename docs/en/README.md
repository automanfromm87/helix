# 🤖 AI Helix Open Source General AI Agent

Official Site: <https://ai-helix.com>

GitHub: <https://github.com/simpleyyt/ai-helix> | Demo: <https://app.ai-helix.com>
...
AI Helix is a general-purpose AI Agent system that can be fully privately deployed and supports running various tools and operations in a sandbox environment.

The goal of AI Helix project is to become a fully privately deployable enterprise-level Helix application. Vertical Helix applications have many repetitive engineering tasks, and this project hopes to unify this part, allowing everyone to build vertical Helix applications like building blocks.

Each service and tool in AI Helix includes a Built-in version that can be fully privately deployed. Later, through A2A and MCP protocols, both Built-in Agents and Tools can be replaced. The underlying infrastructure can also be replaced by providing diverse provider configurations or simple development adaptations. AI Helix supports distributed multi-instance deployment from the architectural design, facilitating horizontal scaling to meet enterprise-level deployment requirements.
