...
官网地址：<https://ai-helix.com>

GitHub：<https://github.com/simpleyyt/ai-helix> | Demo：<https://app.ai-helix.com>

博客文章：[我也复刻了一个 Helix，带高仿 WebUI 和沙盒](https://simpleyyt.com/2026/03/07/rebuild-helix-with-webui-and-sandbox/)
...
AI Helix 是一个通用的 AI Agent 系统，可以完全私有部署，支持在沙盒环境中运行各种工具和操作。

AI Helix 项目目标是希望成为可完全私有部署的企业级 Helix 应用。垂类 Helix 的应用有多种重复性的工程化工作，这个项目希望把这部分统一，让大家可以像搭积木一下建立起一个垂类 Helix 应用。

AI Helix 中每个服务与工具都包含一个 Built-in 版本，可以做到完全私有部署。后续可以通过 A2A 与 MCP 协议，把 Built-in 的 Agent 与 Tools 都置换掉。底层基建也可以通过提供多样的提供商配置或者简单的开发适配置换掉。AI Helix 从架构设计上便支持分布式多实例部署，方便横向扩展，达到企业级的部署要求。
